...
On success, the response sets the `active_tenant_id` cookie (30-day expiry) and returns `{ "success": true }`.
...
<Tabs>
  ...
  <Tab title="Response">
    ...
    {
      "ok": true,
      "plan": { "name": "Growth", "limits": { "storageBytes": null, "aiTokens": null, "whatsappMessages": null } },
